...
int score=0;
		// 2. Set the size of the window in the initializeGui() method below
			...
			if(guess.equals("aronold schwarzenegger")) {
				JOptionPane.showMessageDialog(null, "Correct!");	
				score++;
				}else {
					JOptionPane.showMessageDialog(null, "Incorrect! It's aronold schwarzenegger!");
				}
			// 6. Otherwise:
		...
		guess=JOptionPane.showInputDialog("who is this?");
			if(guess.equals("leonardo dicaprio")) {
				...
				score++;
					...
					JOptionPane.showMessageDialog(null, "Incorrect! It's leonardo dicaprio!");
				
				}
			showNextImage();
JOptionPane.showMessageDialog(null, score);
guess=JOptionPane.showInputDialog("who is this?");
if(guess.equals("morgan freeman")) {
...
if(guess.equals("jack black")) {
	...
	score++;
		...
		JOptionPane.showMessageDialog(null, "Incorrect! It's Jack Black");
